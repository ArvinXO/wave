    ...
    <motion.div ref={ref} className={cn("mx-auto h-full", className)}>
      <div className="absolute -left-6 md:-left-50 top-3">
        <motion.div
          ...
          className="ml-[7px] h-4 w-4 rounded-full border border-netural-200 shadow-sm flex items-center justify-center"
        >
          <motion.div
            transition={{
              duration: 0.2,
      ...
      <div className="absolute -right-6 md:-right-50 top-3">
        <motion.div
          ...
          className="mr-[7px] h-4 w-4 rounded-full border border-netural-200 shadow-sm flex items-center justify-center"
        >
          <motion.div
            transition={{
              duration: 0.2,
